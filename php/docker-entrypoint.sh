...
EXISTING_ENV="/var/www/html/.env"

EXISTING_MIDTRANS_SERVER_KEY=""
EXISTING_MIDTRANS_CLIENT_KEY=""
EXISTING_MIDTRANS_IS_PRODUCTION="false"
EXISTING_MIDTRANS_IS_SANITIZED="true"
EXISTING_MIDTRANS_IS_3DS="true"

if [ -f "$EXISTING_ENV" ]; then
    EXISTING_MIDTRANS_SERVER_KEY=$(grep '^MIDTRANS_SERVER_KEY=' "$EXISTING_ENV" | cut -d '=' -f2-)
    EXISTING_MIDTRANS_CLIENT_KEY=$(grep '^MIDTRANS_CLIENT_KEY=' "$EXISTING_ENV" | cut -d '=' -f2-)
    EXISTING_MIDTRANS_IS_PRODUCTION=$(grep '^MIDTRANS_IS_PRODUCTION=' "$EXISTING_ENV" | cut -d '=' -f2-)
    EXISTING_MIDTRANS_IS_SANITIZED=$(grep '^MIDTRANS_IS_SANITIZED=' "$EXISTING_ENV" | cut -d '=' -f2-)
    EXISTING_MIDTRANS_IS_3DS=$(grep '^MIDTRANS_IS_3DS=' "$EXISTING_ENV" | cut -d '=' -f2-)
fi
...
MIDTRANS_SERVER_KEY=${MIDTRANS_SERVER_KEY:-$EXISTING_MIDTRANS_SERVER_KEY}
MIDTRANS_CLIENT_KEY=${MIDTRANS_CLIENT_KEY:-$EXISTING_MIDTRANS_CLIENT_KEY}
MIDTRANS_IS_PRODUCTION=${MIDTRANS_IS_PRODUCTION:-${EXISTING_MIDTRANS_IS_PRODUCTION:-false}}
MIDTRANS_IS_SANITIZED=${MIDTRANS_IS_SANITIZED:-${EXISTING_MIDTRANS_IS_SANITIZED:-true}}
MIDTRANS_IS_3DS=${MIDTRANS_IS_3DS:-${EXISTING_MIDTRANS_IS_3DS:-true}}
EOF
else
...
MIDTRANS_IS_SANITIZED=${MIDTRANS_IS_SANITIZED:-true}
MIDTRANS_IS_3DS=${MIDTRANS_IS_3DS:-true}
